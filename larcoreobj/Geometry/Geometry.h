...
// #include "larcoreobj/CoreUtils/ServiceUtil.h" // not used; for user's convenience. You're a filthy liar. It is used.*
 
// the following are included for convenience only
#include "larcoreobj/Geometry/ChannelMapAlg.h"
#include "larcoreobj/Geometry/CryostatGeo.h"
#include "larcoreobj/Geometry/TPCGeo.h"
#include "larcoreobj/Geometry/PlaneGeo.h"
#include "larcoreobj/Geometry/WireGeo.h"
#include "larcoreobj/Geometry/OpDetGeo.h"
#include "larcoreobj/Geometry/AuxDetGeo.h"
...
// check that the requirements for geo::Geometry are satisfied. Used here*
